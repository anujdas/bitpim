...
class cl_index_file(BaseProtogenClass):
    ...
    def readfrombuffer(self,buf,autolog=True,logtitle="<read data>"):
        ...
        self.__field_dunno1=UNKNOWN(**{'sizeinbytes': 1352})
    ...
    def __setfield_dunno1(self, value):
        if isinstance(value,UNKNOWN):
            ...
            self.__field_dunno1=UNKNOWN(value,**{'sizeinbytes': 1352})
...
class sms_body(BaseProtogenClass):
    ...
    def readfrombuffer(self,buf,autolog=True,logtitle="<read data>"):
        ...
        self._bufferstartoffset=buf.getcurrentoffset()
        if autolog and self._bufferstartoffset==0: self.autologread(buf, logtitle=logtitle)
        self.__field_dunno1=UNKNOWN(**{'sizeinbytes': 54})
        self.__field_dunno1.readfrombuffer(buf)
    ...
    def __setfield_dunno1(self, value):
        if isinstance(value,UNKNOWN):
            ...
            self.__field_dunno1=UNKNOWN(value,**{'sizeinbytes': 54})
