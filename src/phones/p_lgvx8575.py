...
class callhistory(BaseProtogenClass):
    ...
    def readfrombuffer(self,buf,autolog=True,logtitle="<read data>"):
        ...
        self._bufferstartoffset=buf.getcurrentoffset()
        if autolog and self._bufferstartoffset==0: self.autologread(buf, logtitle=logtitle)
        self.__field_unk0=UINT(**{'sizeinbytes': 4,  'default': 0x00050000 })
        self.__field_unk0.readfrombuffer(buf)
    ...
    def __setfield_unk0(self, value):
        if isinstance(value,UINT):
            ...
            self.__field_unk0=UINT(value,**{'sizeinbytes': 4,  'default': 0x00050000 })
...
class pbfileentry(BaseProtogenClass):
    __fields=['entry_tag', 'unk4', 'mod_date', 'unk0', 'entry_number1', 'entry_number0', 'name', 'groups', 'emails', 'ringtone', 'wallpaper', 'numbertypes', 'unk2', 'numberindices', 'addressindex', 'unk3', 'imindex', 'memo', 'exit_tag', 'dontcare']
    ...
    def writetobuffer(self,buf,autolog=True,logtitle="<written data>"):
        ...
        if self.entry_tag==PB_ENTRY_SOR:
            try: self.__field_unk4
                ...
                self.__field_unk4=UINT(**{'sizeinbytes': 1,  'default': 0 })
            ...
            try: self.__field_groups
                ...
                self.__field_groups=LIST(**{'elementclass': _gen_p_lgvx8575_65, 'length': NUMGROUPS })
            self.__field_groups.writetobuffer(buf)
            try: self.__field_emails
            except:
                self.__field_emails=LIST(**{'elementclass': _gen_p_lgvx8575_67, 'length': NUMEMAILS})
            ...
            try: self.__field_numbertypes
                ...
                self.__field_numbertypes=LIST(**{'elementclass': _gen_p_lgvx8575_71, 'length': NUMPHONENUMBERS})
            ...
            try: self.__field_numberindices
                ...
                self.__field_numberindices=LIST(**{'elementclass': _gen_p_lgvx8575_74, 'length': NUMPHONENUMBERS})
            ...
            try: self.__field_imindex
            except:
                self.__field_imindex=UINT(**{'sizeinbytes': 2,  'default': 0xffff })
            self.__field_imindex.writetobuffer(buf)
            try: self.__field_memo
            except:
                self.__field_memo=USTRING(**{'sizeinbytes': 256,  'raiseonunterminatedread': False, 'default': '', 'encoding': PHONE_ENCODING })
    ...
    def readfrombuffer(self,buf,autolog=True,logtitle="<read data>"):
        ...
        if self.entry_tag==PB_ENTRY_SOR:
            ...
            self.__field_imindex=UINT(**{'sizeinbytes': 2,  'default': 0xffff })
            self.__field_imindex.readfrombuffer(buf)
            self.__field_memo=USTRING(**{'sizeinbytes': 256,  'raiseonunterminatedread': False, 'default': '', 'encoding': PHONE_ENCODING })
    ...
    def __setfield_unk4(self, value):
        if isinstance(value,UINT):
            ...
            self.__field_unk4=UINT(value,**{'sizeinbytes': 1,  'default': 0 })
    ...
    def __setfield_groups(self, value):
        if isinstance(value,LIST):
            ...
            self.__field_groups=LIST(value,**{'elementclass': _gen_p_lgvx8575_65, 'length': NUMGROUPS })
    ...
    def __setfield_emails(self, value):
        if isinstance(value,LIST):
            ...
            self.__field_emails=LIST(value,**{'elementclass': _gen_p_lgvx8575_67, 'length': NUMEMAILS})
    ...
    def __setfield_numbertypes(self, value):
        if isinstance(value,LIST):
            ...
            self.__field_numbertypes=LIST(value,**{'elementclass': _gen_p_lgvx8575_71, 'length': NUMPHONENUMBERS})
    ...
    def __setfield_numberindices(self, value):
        if isinstance(value,LIST):
            ...
            self.__field_numberindices=LIST(value,**{'elementclass': _gen_p_lgvx8575_74, 'length': NUMPHONENUMBERS})
    ...
    def __getfield_imindex(self):
        try: self.__field_imindex
        except:
            self.__field_imindex=UINT(**{'sizeinbytes': 2,  'default': 0xffff })
        return self.__field_imindex.getvalue()

    def __setfield_imindex(self, value):
        if isinstance(value,UINT):
            self.__field_imindex=value
        else:
            self.__field_imindex=UINT(value,**{'sizeinbytes': 2,  'default': 0xffff })

    def __delfield_imindex(self): del self.__field_imindex

    imindex=property(__getfield_imindex, __setfield_imindex, __delfield_imindex, None)
    ...
    def __setfield_memo(self, value):
        if isinstance(value,USTRING):
            ...
            self.__field_memo=USTRING(value,**{'sizeinbytes': 256,  'raiseonunterminatedread': False, 'default': '', 'encoding': PHONE_ENCODING })
    ...
    def containerelements(self):
        ...
        if self.entry_tag==PB_ENTRY_SOR:
            ...
            yield ('imindex', self.__field_imindex, None)
...
class _gen_p_lgvx8575_65(BaseProtogenClass):
    ...
    def __init__(self, *args, **kwargs):
        ...
        dict.update(kwargs)
        # Parent constructor
        super(_gen_p_lgvx8575_65,self).__init__(**dict)
        if self.__class__ is _gen_p_lgvx8575_65:
            self._update(args,dict)
    ...
    def _update(self, args, kwargs):
        super(_gen_p_lgvx8575_65,self)._update(args,kwargs)
        keys=kwargs.keys()
        for key in keys:
            if key in self.__fields:
                setattr(self, key, kwargs[key])
        ...
        # Were any unrecognized kwargs passed in?
        if __debug__:
            self._complainaboutunusedargs(_gen_p_lgvx8575_65,kwargs)
        if len(args):
            dict2={'sizeinbytes': 2,  'default': 0 }
            dict2.update(kwargs)
            kwargs=dict2
            self.__field_gid=UINT(*args,**dict2)
        # Make all P fields that haven't already been constructed
    ...
    def writetobuffer(self,buf,autolog=True,logtitle="<written data>"):
        ...
        try: self.__field_gid
            ...
            self.__field_gid=UINT(**{'sizeinbytes': 2,  'default': 0 })
    ...
    def __setfield_gid(self, value):
        if isinstance(value,UINT):
            ...
            self.__field_gid=UINT(value,**{'sizeinbytes': 2,  'default': 0 })
...
class _gen_p_lgvx8575_67(BaseProtogenClass):
    'Anonymous inner class'
    __fields=['email']
    ...
    def __init__(self, *args, **kwargs):
        ...
        dict.update(kwargs)
        # Parent constructor
        super(_gen_p_lgvx8575_67,self).__init__(**dict)
        if self.__class__ is _gen_p_lgvx8575_67:
            self._update(args,dict)
    ...
    def _update(self, args, kwargs):
        super(_gen_p_lgvx8575_67,self)._update(args,kwargs)
        keys=kwargs.keys()
        for key in keys:
            if key in self.__fields:
                setattr(self, key, kwargs[key])
        ...
        # Were any unrecognized kwargs passed in?
        if __debug__:
            self._complainaboutunusedargs(_gen_p_lgvx8575_67,kwargs)
        if len(args):
...
class _gen_p_lgvx8575_71(BaseProtogenClass):
    'Anonymous inner class'
    __fields=['numbertype']
    ...
    def __init__(self, *args, **kwargs):
        ...
        dict.update(kwargs)
        # Parent constructor
        super(_gen_p_lgvx8575_71,self).__init__(**dict)
        if self.__class__ is _gen_p_lgvx8575_71:
            self._update(args,dict)
    ...
    def _update(self, args, kwargs):
        super(_gen_p_lgvx8575_71,self)._update(args,kwargs)
        keys=kwargs.keys()
        for key in keys:
            if key in self.__fields:
                setattr(self, key, kwargs[key])
        ...
        # Were any unrecognized kwargs passed in?
        if __debug__:
            self._complainaboutunusedargs(_gen_p_lgvx8575_71,kwargs)
        if len(args):
...
class _gen_p_lgvx8575_74(BaseProtogenClass):
    'Anonymous inner class'
    ...
    def __init__(self, *args, **kwargs):
        ...
        dict.update(kwargs)
        # Parent constructor
        super(_gen_p_lgvx8575_74,self).__init__(**dict)
        if self.__class__ is _gen_p_lgvx8575_74:
            self._update(args,dict)
    ...
    def _update(self, args, kwargs):
        super(_gen_p_lgvx8575_74,self)._update(args,kwargs)
        keys=kwargs.keys()
        for key in keys:
            if key in self.__fields:
                setattr(self, key, kwargs[key])
        ...
        # Were any unrecognized kwargs passed in?
        if __debug__:
            self._complainaboutunusedargs(_gen_p_lgvx8575_74,kwargs)
        if len(args):
...
class pafileentry(BaseProtogenClass):
    __fields=['entry_tag', 'pad0', 'mod_date', 'zeros', 'index', 'pb_entry', 'street', 'city', 'state', 'zip_code', 'country', 'pad1', 'exit_tag', 'dontcare']
    ...
    def writetobuffer(self,buf,autolog=True,logtitle="<written data>"):
        ...
        if self.entry_tag==PA_ENTRY_SOR:
            try: self.__field_pad0
                ...
                self.__field_pad0=UINT(**{'sizeinbytes': 1,  'default': 0x00 })
            ...
            try: self.__field_zip_code
                ...
                self.__field_zip_code=USTRING(**{'sizeinbytes': 12,  'encoding': PHONE_ENCODING, 'raiseonunterminatedread': False, 'raiseontruncate': False, 'default': '' })
            ...
            try: self.__field_pad1
                ...
                self.__field_pad1=UINT(**{'sizeinbytes': 2,  'default': 0x00 })
    ...
    def __setfield_pad0(self, value):
        if isinstance(value,UINT):
            ...
            self.__field_pad0=UINT(value,**{'sizeinbytes': 1,  'default': 0x00 })
    ...
    def __setfield_zip_code(self, value):
        if isinstance(value,USTRING):
            ...
            self.__field_zip_code=USTRING(value,**{'sizeinbytes': 12,  'encoding': PHONE_ENCODING, 'raiseonunterminatedread': False, 'raiseontruncate': False, 'default': '' })
    ...
    def __setfield_pad1(self, value):
        if isinstance(value,UINT):
            ...
            self.__field_pad1=UINT(value,**{'sizeinbytes': 2,  'default': 0x00 })
...
class imfileentry(BaseProtogenClass):
    __fields=['entry_tag', 'pad0', 'mod_date', 'zeros', 'index', 'pb_entry', 'service', 'screen_name', 'blank', 'exit_tag', 'dontcare']
    ...
    def __init__(self, *args, **kwargs):
        ...
        dict.update(kwargs)
        # Parent constructor
        super(imfileentry,self).__init__(**dict)
        if self.__class__ is imfileentry:
            self._update(args,dict)
    ...
    def _update(self, args, kwargs):
        super(imfileentry,self)._update(args,kwargs)
        keys=kwargs.keys()
        for key in keys:
            if key in self.__fields:
                setattr(self, key, kwargs[key])
        ...
        # Were any unrecognized kwargs passed in?
        if __debug__:
            self._complainaboutunusedargs(imfileentry,kwargs)
        if len(args): raise TypeError('Unexpected arguments supplied: '+`args`)
        # Make all P fields that haven't already been constructed
    ...
    def writetobuffer(self,buf,autolog=True,logtitle="<written data>"):
        ...
        if self.entry_tag==PI_ENTRY_SOR:
            ...
            try: self.__field_pb_entry
                ...
                self.__field_pb_entry=UINT(**{'sizeinbytes': 2})
            self.__field_pb_entry.writetobuffer(buf)
            try: self.__field_service
            except:
                self.__field_service=UINT(**{'sizeinbytes': 2})
            self.__field_service.writetobuffer(buf)
            try: self.__field_screen_name
            except:
                self.__field_screen_name=USTRING(**{'sizeinbytes': 43,  'encoding': PHONE_ENCODING, 'raiseonunterminatedread': False, 'raiseontruncate': False, 'default': '' })
            self.__field_screen_name.writetobuffer(buf)
            try: self.__field_blank
            except:
                self.__field_blank=USTRING(**{'sizeinbytes': 49,  'raiseonunterminatedread': False, 'default': '', 'encoding': PHONE_ENCODING })
            self.__field_blank.writetobuffer(buf)
            try: self.__field_exit_tag
            except:
                self.__field_exit_tag=USTRING(**{'sizeinbytes': 6,  'encoding': PHONE_ENCODING, 'raiseonunterminatedread': False, 'raiseontruncate': False, 'default': '</PI>'})
            self.__field_exit_tag.writetobuffer(buf)
        else:
            try: self.__field_dontcare
            except:
                self.__field_dontcare=DATA(**{'sizeinbytes': 123,  'default': '\xff'*123 })
            self.__field_dontcare.writetobuffer(buf)
        self._bufferendoffset=buf.getcurrentoffset()
        if autolog and self._bufferstartoffset==0: self.autologwrite(buf, logtitle=logtitle)
    ...
    def readfrombuffer(self,buf,autolog=True,logtitle="<read data>"):
        ...
        if self.entry_tag==PI_ENTRY_SOR:
            ...
            self.__field_pb_entry.readfrombuffer(buf)
            self.__field_service=UINT(**{'sizeinbytes': 2})
            self.__field_service.readfrombuffer(buf)
            self.__field_screen_name=USTRING(**{'sizeinbytes': 43,  'encoding': PHONE_ENCODING, 'raiseonunterminatedread': False, 'raiseontruncate': False, 'default': '' })
            self.__field_screen_name.readfrombuffer(buf)
            self.__field_blank=USTRING(**{'sizeinbytes': 49,  'raiseonunterminatedread': False, 'default': '', 'encoding': PHONE_ENCODING })
            self.__field_blank.readfrombuffer(buf)
            self.__field_exit_tag=USTRING(**{'sizeinbytes': 6,  'encoding': PHONE_ENCODING, 'raiseonunterminatedread': False, 'raiseontruncate': False, 'default': '</PI>'})
            self.__field_exit_tag.readfrombuffer(buf)
        else:
            self.__field_dontcare=DATA(**{'sizeinbytes': 123,  'default': '\xff'*123 })
    ...
    def __getfield_service(self):
        try: self.__field_service
        except:
            self.__field_service=UINT(**{'sizeinbytes': 2})
        return self.__field_service.getvalue()

    def __setfield_service(self, value):
        if isinstance(value,UINT):
            self.__field_service=value
        else:
            self.__field_service=UINT(value,**{'sizeinbytes': 2})

    def __delfield_service(self): del self.__field_service

    service=property(__getfield_service, __setfield_service, __delfield_service, None)

    def __getfield_screen_name(self):
        try: self.__field_screen_name
        except:
            self.__field_screen_name=USTRING(**{'sizeinbytes': 43,  'encoding': PHONE_ENCODING, 'raiseonunterminatedread': False, 'raiseontruncate': False, 'default': '' })
        return self.__field_screen_name.getvalue()

    def __setfield_screen_name(self, value):
        if isinstance(value,USTRING):
            self.__field_screen_name=value
        else:
            self.__field_screen_name=USTRING(value,**{'sizeinbytes': 43,  'encoding': PHONE_ENCODING, 'raiseonunterminatedread': False, 'raiseontruncate': False, 'default': '' })

    def __delfield_screen_name(self): del self.__field_screen_name

    screen_name=property(__getfield_screen_name, __setfield_screen_name, __delfield_screen_name, None)

    def __getfield_blank(self):
        try: self.__field_blank
        except:
            self.__field_blank=USTRING(**{'sizeinbytes': 49,  'raiseonunterminatedread': False, 'default': '', 'encoding': PHONE_ENCODING })
        return self.__field_blank.getvalue()

    def __setfield_blank(self, value):
        if isinstance(value,USTRING):
            self.__field_blank=value
        else:
            self.__field_blank=USTRING(value,**{'sizeinbytes': 49,  'raiseonunterminatedread': False, 'default': '', 'encoding': PHONE_ENCODING })

    def __delfield_blank(self): del self.__field_blank

    blank=property(__getfield_blank, __setfield_blank, __delfield_blank, None)
    ...
    def __setfield_exit_tag(self, value):
        if isinstance(value,USTRING):
            ...
            self.__field_exit_tag=USTRING(value,**{'sizeinbytes': 6,  'encoding': PHONE_ENCODING, 'raiseonunterminatedread': False, 'raiseontruncate': False, 'default': '</PI>'})
    ...
    def __setfield_dontcare(self, value):
        if isinstance(value,DATA):
            ...
            self.__field_dontcare=DATA(value,**{'sizeinbytes': 123,  'default': '\xff'*123 })
    ...
    def containerelements(self):
        ...
        if self.entry_tag==PI_ENTRY_SOR:
            ...
            yield ('index', self.__field_index, None)
            yield ('pb_entry', self.__field_pb_entry, None)
            yield ('service', self.__field_service, None)
            yield ('screen_name', self.__field_screen_name, None)
            yield ('blank', self.__field_blank, None)
            yield ('exit_tag', self.__field_exit_tag, None)
        else:
            yield ('dontcare', self.__field_dontcare, None)
...
class imfile(BaseProtogenClass):
    __fields=['items']
    ...
    def __init__(self, *args, **kwargs):
        ...
        dict.update(kwargs)
        # Parent constructor
        super(imfile,self).__init__(**dict)
        if self.__class__ is imfile:
            self._update(args,dict)
    ...
    def _update(self, args, kwargs):
        super(imfile,self)._update(args,kwargs)
        keys=kwargs.keys()
        for key in keys:
            if key in self.__fields:
                setattr(self, key, kwargs[key])
        ...
        # Were any unrecognized kwargs passed in?
        if __debug__:
            self._complainaboutunusedargs(imfile,kwargs)
        if len(args):
            dict2={ 'elementclass': imfileentry,             'length': NUMPHONEBOOKENTRIES,             'createdefault': True}
            dict2.update(kwargs)
            kwargs=dict2
            self.__field_items=LIST(*args,**dict2)
        # Make all P fields that haven't already been constructed
    ...
    def writetobuffer(self,buf,autolog=True,logtitle="<written data>"):
        ...
        try: self.__field_items
            ...
            self.__field_items=LIST(**{ 'elementclass': imfileentry,             'length': NUMPHONEBOOKENTRIES,             'createdefault': True})
        self.__field_items.writetobuffer(buf)
        self._bufferendoffset=buf.getcurrentoffset()
        if autolog and self._bufferstartoffset==0: self.autologwrite(buf, logtitle=logtitle)
    ...
    def __setfield_items(self, value):
        if isinstance(value,LIST):
            ...
            self.__field_items=LIST(value,**{ 'elementclass': imfileentry,             'length': NUMPHONEBOOKENTRIES,             'createdefault': True})
