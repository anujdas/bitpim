...
class amsregistry(BaseProtogenClass):
    ...
    def readfrombuffer(self,buf,autolog=True,logtitle="<read data>"):
        ...
        self._bufferstartoffset=buf.getcurrentoffset()
        if autolog and self._bufferstartoffset==0: self.autologread(buf, logtitle=logtitle)
        self.__field_items=LIST(**{'elementclass': _gen_p_samsungspha640_134, 'length': 150})
        self.__field_items.readfrombuffer(buf)
        self.__field_info=LIST(**{'elementclass': _gen_p_samsungspha640_137, 'length': 320})
        self.__field_info.readfrombuffer(buf)
        self.__field_info2=LIST(**{'elementclass': _gen_p_samsungspha640_155, 'length': 100})
    ...
    def __setfield_items(self, value):
        if isinstance(value,LIST):
            ...
            self.__field_items=LIST(value,**{'elementclass': _gen_p_samsungspha640_134, 'length': 150})
    ...
    def __setfield_info(self, value):
        if isinstance(value,LIST):
            ...
            self.__field_info=LIST(value,**{'elementclass': _gen_p_samsungspha640_137, 'length': 320})
    ...
    def __setfield_info2(self, value):
        if isinstance(value,LIST):
            ...
            self.__field_info2=LIST(value,**{'elementclass': _gen_p_samsungspha640_155, 'length': 100})
...
class _gen_p_samsungspha640_134(BaseProtogenClass):
    ...
    def __init__(self, *args, **kwargs):
        ...
        dict.update(kwargs)
        # Parent constructor
        super(_gen_p_samsungspha640_134,self).__init__(**dict)
        if self.__class__ is _gen_p_samsungspha640_134:
            self._update(args,dict)
    ...
    def _update(self, args, kwargs):
        super(_gen_p_samsungspha640_134,self)._update(args,kwargs)
        keys=kwargs.keys()
        for key in keys:
            if key in self.__fields:
                setattr(self, key, kwargs[key])
        ...
        # Were any unrecognized kwargs passed in?
        if __debug__:
            self._complainaboutunusedargs(_gen_p_samsungspha640_134,kwargs)
        if len(args): raise TypeError('Unexpected arguments supplied: '+`args`)
        # Make all P fields that haven't already been constructed
...
class _gen_p_samsungspha640_137(BaseProtogenClass):
    'Anonymous inner class'
    ...
    def __init__(self, *args, **kwargs):
        ...
        dict.update(kwargs)
        # Parent constructor
        super(_gen_p_samsungspha640_137,self).__init__(**dict)
        if self.__class__ is _gen_p_samsungspha640_137:
            self._update(args,dict)
    ...
    def _update(self, args, kwargs):
        super(_gen_p_samsungspha640_137,self)._update(args,kwargs)
        keys=kwargs.keys()
        for key in keys:
            if key in self.__fields:
                setattr(self, key, kwargs[key])
        ...
        # Were any unrecognized kwargs passed in?
        if __debug__:
            self._complainaboutunusedargs(_gen_p_samsungspha640_137,kwargs)
        if len(args): raise TypeError('Unexpected arguments supplied: '+`args`)
        # Make all P fields that haven't already been constructed
...
class _gen_p_samsungspha640_155(BaseProtogenClass):
    'Anonymous inner class'
    ...
    def __init__(self, *args, **kwargs):
        ...
        dict.update(kwargs)
        # Parent constructor
        super(_gen_p_samsungspha640_155,self).__init__(**dict)
        if self.__class__ is _gen_p_samsungspha640_155:
            self._update(args,dict)
    ...
    def _update(self, args, kwargs):
        super(_gen_p_samsungspha640_155,self)._update(args,kwargs)
        keys=kwargs.keys()
        for key in keys:
            if key in self.__fields:
                setattr(self, key, kwargs[key])
        ...
        # Were any unrecognized kwargs passed in?
        if __debug__:
            self._complainaboutunusedargs(_gen_p_samsungspha640_155,kwargs)
        if len(args): raise TypeError('Unexpected arguments supplied: '+`args`)
        # Make all P fields that haven't already been constructed
