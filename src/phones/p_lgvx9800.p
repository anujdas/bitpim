...
PACKET indexentry:
    2 UINT index
    2 UINT type
    80 STRING {'raiseonunterminatedread': False, 'raiseontruncate': False } filename  "includes full pathname"
...
PACKET pbentry:
   ...
   * LIST {'length': NUMPHONENUMBERS} +numbers:
    ...
    61 STRING {'default': '', 'raiseonunterminatedread': False} +memo
   * UNKNOWN +unknown
...
PACKET scheduleevent:
    ...
    33 STRING {'encoding': PHONE_ENCODING, 'raiseonunterminatedread': False, 'raiseontruncate': False } description
    4 LGCALDATE start
    4 LGCALDATE end
...
PACKET textmemo:
    301 STRING { 'encoding': PHONE_ENCODING, 'raiseonunterminatedread': False, 'raiseontruncate': False } text
